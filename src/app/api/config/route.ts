...
export async function GET(req: Request) {
  try {
    ...
    return NextResponse.json({ 
      ...
      statusBannerSubtitle: config.statusBannerSubtitle || null,
      statusBannerVideoUrl: config.statusBannerVideoUrl || '',
...
export async function POST(req: Request) {
  try {
    ...
    const success = saveTelegramConfigServer({ 
      ...
      statusBannerSubtitle: statusBannerSubtitle !== undefined ? statusBannerSubtitle : config.statusBannerSubtitle,
      statusBannerVideoUrl: statusBannerVideoUrl !== undefined ? statusBannerVideoUrl : (config.statusBannerVideoUrl || ''),
