...
import { Dish, Category, Promotion, Story, MultilingualText, TenantRestaurant } from '../types';
...
export interface HomeClientProps {
  ...
  initialConfig?: {
    ...
    heroSlogan?: MultilingualText | null;
    statusBannerText?: MultilingualText | null;
    statusBannerSubtitle?: MultilingualText | null;
        ...
        <div className="z-10 flex flex-col items-center" style={{ marginTop: 'calc(40px + env(safe-area-inset-top, 0px))' }}>
          {initialTenant && initialTenant.slug && initialTenant.slug !== 'porto-bar' ? (
            ...
            >
              ...
              <p className="text-[10px] tracking-[0.25em] text-porto-gold font-bold uppercase mt-1.5 drop-shadow">
                {(initialTenant as any).tagline || 'Премиальный ресторан & бар'}
              </p>
            </motion.div>
          ) : (
            <motion.div
